				...
				%>
						<div class="product">
							<div class="product-image">
								<img src="pics/<%=productDAO.getProduct(h.getProduct_id()).getImage()%>">
							</div>
							<div class="product-details">
								<div class="product-title">
									<%=productDAO.getProduct(h.getProduct_id()).getName()%>
								</div>
								<p class="product-description"></p>
							</div>
							<div class="product-price"><%=productDAO.getProduct(h.getProduct_id()).getPrice()%>
							</div>
							<div class="product-quantity cart_quantity_button">
								<%=h.getAmount()%>
							</div>
							<div class="product-line-price" style="text-align: right"><%=nf.format(h.getCost())%>
								zł
							</div>
						</div>
				<%
