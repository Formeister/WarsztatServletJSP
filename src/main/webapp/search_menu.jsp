...
<body>
	...
	<div class="container">
		...
		<form accept-charset="utf-8" method="post" action="SearchServlet" name="SearchServlet">
                        <p>
                        <label for="tensp">Nazwa produktu</label>
                        <br>
                        <input accept-charset="utf-8" type="text"  name="nameProduct" style="width:97%">
                        </p>
                        <p>
                        <label for="type">Typ</label>
                        <br>
                        <select accept-charset="utf-8" name="nameCategory" style="width:100%">
