...
<body>
	...
	<div id="main">
		...
		<div id="content">
			<div class="left-1">
				<img src="pics/<%=productDAO.getProduct(Integer.parseInt(product_id)).getImage()%>" width="200" height="200" alt="Product"/>
			</div>
			<div class="left-2">
				<table>
					<tr class="row1">
						<td class="col2" colspan="2" style="padding: 10px; color: blue; font-size: 15px; text-transform: uppercase; text-align: center; font-weight: bold"><%=productDAO.getProduct(Integer.parseInt(product_id)).getName()%></td>
					</tr>
					<tr class="row2">
						<td class="col1">Typ:</td>
						<td class="col2"><%=productDAO.getProduct(Integer.parseInt(product_id)).getType()%></td>
					</tr>

					<tr class="row2">
						<td class="col1">Cena:</td>
						<td class="col2"><%=nf.format(productDAO.getProduct(Integer.parseInt(product_id)).getPrice()) %> zł</td>
					</tr>
			...
			<div
				...
				<a href="#"><img src="images/giohang.png" alt="Koszyk"/></a>
			...
			<div
				style="margin-left: auto; margin-right: auto; text-align: center; margin-top: 10px; padding: 10px; clear: both;">
				<a href="login.jsp"><img src="images/giohang.png" alt="Koszyk"/></a>
			</div>
			<%} %>
