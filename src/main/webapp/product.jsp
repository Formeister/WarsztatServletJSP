					...
					<ul class="products homepage">
						<c:forEach items="${products}" var="product">
							<li class="preorder">
								...
								<a href="detail.jsp?product_id=${product.product_id}">
									<img src="pics/${product.image}" width="250" height="250" alt="Product"/>
									<h3>${product.name}</h3>
									<h4>
										Cena:
										${product.price}
									...
									<p class="info">
										<span>Typ: ${product.type}</span>
										<span>Cena: ${product.price} zł</span>
										<span>Opis: ${product.desc} </span>
									</p>
								</a>
							</li>
						</c:forEach>
