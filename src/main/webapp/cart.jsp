			...
			<div class="shopping-cart">
				...
				<div class="product">
					<div class="product-image">
						<img
							src="pics/<%=productDAO.getProduct(c.getP().getProduct_id())
							.getImage()%>">
					</div>
					<div class="product-details">
						<div class="product-title">
							<%=productDAO.getProduct(c.getP().getProduct_id())
							.getName()%>
						</div>
					...
					<div class="product-line-price" style="text-align: right"><%=nf.format(productDAO.getProduct(
						...
						<a
					href="CartServlet?command=removeCart&product_id=<%=c.getP().getProduct_id()%>"><img style="margin-left: 10px"
